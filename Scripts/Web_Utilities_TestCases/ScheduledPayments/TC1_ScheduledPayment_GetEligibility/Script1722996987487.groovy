...
try {
	WebUI.callTestCase(findTestCase('Re-Usable Script/SchedulePayment_GetEligibility'), [:], FailureHandling.STOP_ON_FAILURE)	//	get retrieve booking request from Object Repository
	...
	WebUI.takeScreenshot("./screenshots/Failed_Scheduled_GetEligibility.png")
