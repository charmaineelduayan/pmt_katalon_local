...
Wallet.click()
Function.offset()
WebElement Replace = driver.findElement(By.xpath('//a[normalize-space()=\'Replace\']'))
Replace.click()
...
// ** BOOKINGDETAILS
idToBeReplaced = WS.getElementPropertyValue(Request, '[0].idToBeReplaced')
println('idToBeReplaced : ' + idToBeReplaced)

// ** CARDS
paymentMethod_type = WS.getElementPropertyValue(Request2, '[0].paymentMethod_type').toLowerCase()
println('paymentMethod_type : ' + paymentMethod_type)
cardholderName = WS.getElementPropertyValue(Request2, '[0].cardholderName')
